...
const SubmissionsPage = () => {
  ...
  useEffect(() => {
    // Detect if on 'my-submissions' route
    const isMySubmissions = window.location.pathname.includes('my-submissions');
    const username = paramUsername || (isMySubmissions && authUser?.username);
